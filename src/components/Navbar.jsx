        ...
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6E5FE3]'>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#555860]'>
                        <a className='flex justify-between items-center w-full text-gray-300' href="https://drive.google.com/file/d/1Fot-nvr9-nfQPXugfUBGkMLiQazD5yIj/view?usp=sharing" target="_newtab">Resume <BsFillPersonLinesFill size={30} /></a>
                    </li>
                </ul>
            </div>
