...
const Work = () => {
    return (
        <div name='work' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full sm:text-center'>
                <div className='pb-8'>
                ...
                {/**container */}
                <div className='grid sm:grid-cols2 md:grid-cols-2 gap-4 lg:grid-cols-2'>
